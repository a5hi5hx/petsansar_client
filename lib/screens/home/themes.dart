...
String get offerFamily => typography.offerFamily;
  TextStyle get offer => typography.offer;
   TextStyle get offer2 => typography.offer2;
...
class ThemeTypography extends Typography {
  ...
  TextStyle get bodyText2 => GoogleFonts.getFont(
      ...
      String get offerFamily => 'Poppins';
  TextStyle get offer => GoogleFonts.getFont(
        'Poppins',
        color: Colors.red,
        fontWeight: FontWeight.w600,
        fontSize: 18,
      ...
      TextStyle get offer2 => GoogleFonts.getFont(
        'Poppins',
        color: Colors.red,
        fontWeight: FontWeight.w600,
        fontSize: 16,
